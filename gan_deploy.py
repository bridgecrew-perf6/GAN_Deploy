...
test = Load_model(mask_g_model, face_g_model, mask_checkpoint_dir="/content/drive/MyDrive/SJSU assignment Docs/Spring 22/Face Mask project/GAN-based-face-mask-removal-version2-forked/mask32_checkpoints", face_checkpoint_dir="/content/drive/MyDrive/SJSU assignment Docs/Spring 22/Face Mask project/GAN-based-face-mask-removal-version2-forked/face_checkpoints")
test.load()
